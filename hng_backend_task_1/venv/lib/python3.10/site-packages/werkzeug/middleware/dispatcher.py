...
This example dispatches to an API project under "/api", an admin project
under "/admin", and an project that serves frontend files for all other
requests::

    project = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
