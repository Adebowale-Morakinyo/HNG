...
class LintMiddleware:
    ...
    .. code-block:: python
        ...
        project = LintMiddleware(project)
    """
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> t.Iterable[bytes]:
        if len(args) != 2:
            warn("A WSGI project takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI project does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
